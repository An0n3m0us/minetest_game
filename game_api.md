...
* Registers a slab
* `subname`: Basically the material name (e.g. cobble)
...
`stairs.register_stair_and_slab(subname, recipeitem, groups, images, desc_stair, desc_slab, sounds, worldaligntex, desc_stair_inner, desc_stair_outer)`
